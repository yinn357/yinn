...
import top.yinn.common.database.datasource.BaseDatabaseConfiguration;
...
@Slf4j
@MapperScan(
		basePackages = {"top.yinn",},
		annotationClass = Repository.class,
		sqlSessionFactoryRef = DatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class DatabaseAutoConfiguration extends BaseDatabaseConfiguration {
	/**
	 * 每个数据源配置不同即可
	 */
	final static String DATABASE_PREFIX = "master";

	public DatabaseAutoConfiguration(MybatisPlusProperties properties,
