...
import top.yinn.tools.xss.converter.XssStringJsonDeserializer;
import top.yinn.tools.xss.filter.XssFilter;
 ...
 *
 */
@ConditionalOnProperty(prefix ="yinn.xss", name = "enabled" ,havingValue="true",matchIfMissing = true)
