...
import static top.yinn.core.exception.BaseException.BASE_VALID_PARAM;
...
public class BizAssert {
	...
	public static void fail(BaseEnum<Integer> exceptionCode) {
	 ...
	 * @
	 */
	public static void isTrue(boolean condition, BaseEnum exceptionCode) {
		if (!condition) {
			fail(exceptionCode);
		}
	}
	 ...
	 * @
	 */
	public static void isFalse(boolean condition, BaseEnum exceptionCode) {
		if (condition) {
			fail(exceptionCode);
		}
	}
	 ...
	 * @
	 */
	public static void notNull(Object object, BaseEnum exceptionCode) {
		if (object == null) {
			fail(exceptionCode);
		}
	}
	 ...
	 * @
	 */
	public static void isNull(Object object, BaseEnum exceptionCode) {
		if (object != null) {
			fail(exceptionCode);
		}
	}
	 ...
	 * @
	 */
	public static void notEmpty(Collection<?> collection, BaseEnum exceptionCode) {
		if (collection == null || collection.isEmpty()) {
			fail(exceptionCode);
		}
	}

	public static <T> void notEmpty(T[] array, BaseEnum exceptionCode) {
	 ...
	 * @
	 */
	public static void notEmpty(String value, BaseEnum exceptionCode) {
	 ...
	 * @
	 */
	public static void notEquals(Object unexpected, Object actual, BaseEnum exceptionCode) {
	 ...
	 * @
	 */
	public static void equals(String expected, String actual, BaseEnum exceptionCode) {
