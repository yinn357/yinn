...
public final class RedisUtil {
	 ...
	 * @return
	 */
	public <T> boolean lSet(String key, Collection<T> value) {
		try {
	 ...
	 * @return
	 */
	public <T> boolean lSet(String key, Collection<T> value, long time) {
		try {
			redisTemplate.opsForList().rightPushAll(key, value);
			if (time > 0) {
				expire(key, time);
	 ...
	 * @return
	 */
	public <T> boolean rPush(String key, Collection<T> value) {
		try {
			redisTemplate.opsForList().rightPushAll(key, value);
			return true;
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public <T> boolean lPush(String key, Collection<T> value) {
		try {
			redisTemplate.opsForList().rightPushAll(key, value);
			return true;
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public <T> T rPopAndLPush(String key, String destKey) {
		try {
			ListOperations<String, T> operations = redisTemplate.opsForList();
			return operations.rightPopAndLeftPush(key, destKey);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
