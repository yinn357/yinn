...
public class BizException extends BaseUncheckedException {
	...
	public BizException(BaseEnum<Integer> ex) {
		super(ex.getValue(), ex.getLabel());
	}
	...
	public static BizException wrap(BaseEnum<Integer> ex) {
		return new BizException(ex.getValue(), ex.getLabel());
	}
